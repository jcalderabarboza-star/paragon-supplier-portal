...
export const goodsReceiptEn: Record<string, string> = {
  ...
  'goodsReceipt.toast.overrideHold.title': 'Hold override not available yet',
  'goodsReceipt.toast.overrideHold.desc': 'Nothing was overridden. An override must name the person who accepted the risk, and the platform cannot yet name a person.',
  'goodsReceipt.toast.openingSap.title': 'SAP document view not available yet — nothing was opened.',
  'goodsReceipt.toast.openingSap.fallbackDoc': 'Material document',
  'goodsReceipt.toast.export.title': 'Goods receipt export not available yet',
  'goodsReceipt.toast.export.desc': 'No file was generated — goods-receipt export is not wired to a real system.',
...
export const goodsReceiptId: Record<string, string> = {
  ...
  'goodsReceipt.toast.overrideHold.title': 'Penimpaan penahanan belum tersedia',
  'goodsReceipt.toast.overrideHold.desc': 'Tidak ada yang ditimpa. Penimpaan harus menyebut orang yang menerima risiko, dan platform belum dapat menyebut nama orang.',
  'goodsReceipt.toast.openingSap.title': 'Tampilan dokumen SAP belum tersedia — tidak ada yang dibuka.',
  'goodsReceipt.toast.openingSap.fallbackDoc': 'Dokumen material',
  'goodsReceipt.toast.export.title': 'Ekspor penerimaan barang belum tersedia',
  'goodsReceipt.toast.export.desc': 'Tidak ada berkas yang dibuat — ekspor penerimaan barang belum tersambung ke sistem nyata.',
