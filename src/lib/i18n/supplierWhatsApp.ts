...
export const supplierWhatsAppEn: Record<string, string> = {
  ...
  'supplierWhatsApp.cap.requestDocs.desc': 'DOKUMEN [PO number] — bot sends PDF instantly',
  'supplierWhatsApp.cap.checkPayment.title': 'Check Payment Status',
  'supplierWhatsApp.cap.checkPayment.desc': 'BAYAR [invoice number] — get real-time payment info',
...
export const supplierWhatsAppId: Record<string, string> = {
  ...
  'supplierWhatsApp.cap.requestDocs.desc': 'DOKUMEN [nomor PO] — bot mengirim PDF secara instan',
  'supplierWhatsApp.cap.checkPayment.title': 'Cek Status Pembayaran',
  'supplierWhatsApp.cap.checkPayment.desc': 'BAYAR [nomor faktur] — dapatkan info pembayaran waktu nyata',
