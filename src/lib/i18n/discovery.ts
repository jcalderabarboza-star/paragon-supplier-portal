...
export const discoveryEn: Record<string, string> = {
  ...
  'discovery.toast.qualStarted.title': 'Qualification not available yet — nothing was started for {{name, stop}}.',
  'discovery.toast.rfqInvited.title': '{{name}} was not invited to the RFQ',
  'discovery.toast.rfqInvited.desc': 'Nothing was sent — email invitations are not wired to a real channel.',
  'discovery.toast.statusUpdated.title': 'Status update not available yet — nothing changed for {{name, stop}}.',
...
export const discoveryId: Record<string, string> = {
  ...
  'discovery.toast.qualStarted.title': 'Kualifikasi belum tersedia — tidak ada yang dimulai untuk {{name, stop}}.',
  'discovery.toast.rfqInvited.title': '{{name}} tidak diundang ke RFQ',
  'discovery.toast.rfqInvited.desc': 'Tidak ada yang dikirim — undangan email belum tersambung ke kanal nyata.',
  'discovery.toast.statusUpdated.title': 'Pembaruan status belum tersedia — tidak ada perubahan untuk {{name, stop}}.',
  // — Empty state (all-empty early return) —
