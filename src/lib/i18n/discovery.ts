...
export const discoveryEn: Record<string, string> = {
  ...
  'discovery.toast.qualStarted.title': 'Qualification not available yet — nothing was started for {{name}}.',
  ...
  'discovery.toast.statusUpdated.title': 'Status update not available yet — nothing changed for {{name}}.',
...
export const discoveryId: Record<string, string> = {
  ...
  'discovery.toast.qualStarted.title': 'Kualifikasi belum tersedia — tidak ada yang dimulai untuk {{name}}.',
  ...
  'discovery.toast.statusUpdated.title': 'Pembaruan status belum tersedia — tidak ada perubahan untuk {{name}}.',
  // — Empty state (all-empty early return) —
