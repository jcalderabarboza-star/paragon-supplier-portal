...
| **DP-1** | Fiori-aligned visual language — light surfaces, Odyssey colors as accents, semantic color reserved for state. A standing design principle applied opportunistically per touched page from Batch 1.1b onward. Full text in `CLAUDE.md` → Design principles. | Standing; see `CLAUDE.md`. |
